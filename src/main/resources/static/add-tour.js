...
function populateForm(tour) {
  ...
  // Nếu có typetour, set giá trị cho dropdown
  if (tour.typetour) {
...
document
  ...
  .addEventListener("submit", async function (e) {
    ...
    const tourData = {
      ...
      typetour: document.getElementById("typetour").value.trim(),
      price: parseFloat(document.getElementById("price").value) || 0,
      rating: parseInt(document.getElementById("rating").value) || null,
      imageUrl: document.getElementById("imageUrl").value.trim(),
      description: document.getElementById("description").value.trim(),
      // Thêm thông tin ngày giờ hiện tại và người dùng
      modifiedDate: "2025-06-07 20:11:57",
      modifiedBy: "nqa5785",
    };
